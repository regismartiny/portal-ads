        ...
        <div class="row row-grid">
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-footer">
                        <small class="text-muted">Data de publicação: 01/10/2017</small>
                        <span class="see-more"><a href="/visao/paginas-publicas/evento-detalhe.php?id=3" title="Ver mais">+</a></span>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-footer">
                        <small class="text-muted">Data de publicação: 01/10/2017</small>
                        <span class="see-more"><a href="/visao/paginas-publicas/evento-detalhe.php?id=4" title="Ver mais">+</a></span>
                    </div>
                </div>
            </div>
        </div>
