    ...
    <div class="col-5">
        <form method='post' action='contato.php'>
            <div class="form-group row">
                <label for="categoria" class="col-sm-4 col-md-4 col-form-label">Tipo de mensagem:</label>
            ...
            <div class="form-group row">
                <label for="nome" class="col-sm-4 col-md-4 col-form-label">Seu nome:</label>
                <div class="col-sm-10 col-md-8">
                    <input type="text" class="form-control" id="nome" name='nome' required>
                </div>
            </div>
            <div class="form-group row">
                <label for="email" class="col-sm-4 col-md-4 col-form-label">Seu e-mail:</label>
                <div class="col-sm-10 col-md-8">
                    <input type="email" class="form-control" id="email" name='email' required>
                </div>
            </div>
            <div class="form-group row">
                <label for="mensagem" class="col-sm-4 col-md-4 col-form-label">Digite sua mensagem:</label>
                <div class="col-sm-10 col-md-8">
