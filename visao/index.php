...
<body>
    <div id="topo" class="container-fluid fixed-top">
        <div class="row">
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav nav-fill w-100 align-items-start">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/paginas-publicas/noticias.html">Notícias</a>
                            </li>
                            <li class="nav-item ">
    ...
    <div class="container-fluid" id="container-conteudo"></div>
    <footer class="footer">
        <div class="container">
            <div class="row">
                <div class="col-auto mr-auto">
