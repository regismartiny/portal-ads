                            ...
                            <?php 
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
											...
											<a class="dropdown-item" href="/visao/professor/cadNoticia.php">Cadastro de Projetos</a>
                                            <a class="dropdown-item" href="/visao/professor/lstNoticia.php">Lista de Projetos</a>
                                            <form method="post" action="/controle/logout.php">
